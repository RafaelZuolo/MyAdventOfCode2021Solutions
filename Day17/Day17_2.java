...
//
// Now we must consider negatives values for the y initial velocity.
// But its easy to see that the must be at least yMin.
...
public class Day17_2 {
    ...
    public static void main(String[] args) {
        int count = 0; // count the number of initia velocities that work
        long vxInit = minVX;
        long vyInit = minVY;
        long currentMaxY = 0;
        long globalMaxY = 0;
        ...
        System.out.println("Number of correct initial velocities: "+count);
    }
}
