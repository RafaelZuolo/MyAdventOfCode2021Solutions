...
public class Day20_2 {
    ...
    public static char[][] iterate (char[][] inputImg, 
                            String enhancementAlg, int currentIteration) {
        
        int changing = 0;
        if (enhancementAlg.charAt(0) == '#') changing = 1;
        int xSize = inputImg.length;
        int ySize = inputImg[0].length;         
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 50; i++) {
            inputImg = iterate(inputImg, enhancementAlg, currentIteration);
            currentIteration++;
        }
